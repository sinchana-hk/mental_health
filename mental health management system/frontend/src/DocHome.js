...
import DocBackground from './images/db.jpg'
import Doctor from './images/dbd.jpeg'
import './App.css';
    ...
    return (
        <Grommet full theme={theme}>
            <Box fill direction="row">
                ...
                {/* <Image src={DocBackground} fit='cover' /> */}
...
export class DocHome extends Component {
    ...
    render() {
        const Header = () => (
            ...
            >
                <a style={{ color: 'inherit', textDecoration: 'inherit'}} href="/"><Heading level='3' margin='none'>Mental Health Management System</Heading></a>
